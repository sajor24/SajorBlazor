...
namespace SajorWPF.ViewModels
{
    ...
    {
        private readonly ICreateCommand _createEmployee;
        private readonly IGetAllEmployee _GetAllEmployee;
        private readonly IUpdateCommand _updateEmployee;
        private readonly IDeleteCommand _deleteEmployee;
        ...
        public AddEmployeeViewModel(
            ICreateCommand createEmployee,
            IGetAllEmployee GetAllEmployee,
            IUpdateCommand updateEmployee,
            IDeleteCommand deleteEmployee,
            ...
            else
            {
                try
                {
                    var employee = new Employee
                    {
                        FirstName = FirstName,
                        LastName = LastName,
                        Age = int.TryParse(Age, out var age) ? age : 0,
                        Position = Position
                    };
        ...
        {
            var employees = await _GetAllEmployee.ExecuteAsync();
